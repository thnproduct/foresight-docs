...
A GitHub Action to analyze test and/or coverage results. Foresight’s [Test Kit](https://github.com/runforesight/foresight-test-kit-action) action integrates with your Github Actions pipelines.
...
You need to integrate Test Kit action to your CI pipeline in order to use [Test Monitoring](https://docs.runforesight.com/features/test-dashboard) and 
[Change Impact Analysis](https://docs.runforesight.com/features/analyze-code-change-impact) features.
...
|----------------|----------------|----------------|
|CYPRESS<sup>1</sup>|JSON| [Yes](/features/flaky-tests#cypress) |
|CYPRESS<sup>1</sup>|JUNIT| No |
|JUNIT|JSON| [Yes](/features/flaky-tests#cypress) | 
|JUNIT|TXT| No |
|JEST|JSON| [Yes](/features/flaky-tests#jest) | 
|JEST|JUNIT| No | 
|PYTEST|JSON| [Yes](/features/flaky-tests#pytest) |
|PYTEST|JUNIT| No |
|XUNIT2|n/a*| No |
|XUNIT2|TRX| No |
|GOLANG|JSON| [Yes](/features/flaky-tests#golang) |
|GOLANG|TEXT| No |
|ELIXIR|JUNIT| No |
|TESTNG|n/a*| No |
